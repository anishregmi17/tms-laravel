1. install composer & set up
   install Nodeljs  & set up
...
8. Create Model, controller and migration
// php artisan make:model Task --migration --controller --resource

9. Run the created file
	http://127.0.0.1:8000/task   : taskController ko index function

10. Create table 
	database/migration/tasks-table
	add necessary fields
and update model also

11. add necessary thing on create file
...
Clone project
1. firstly, create .env file 
2. and create database and update .env file
